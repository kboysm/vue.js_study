    ...
    <v-layout row wrap>
      <v-flex xs12 sm3>
        <v-card>
          ...
          <v-card-actions>
            <v-btn text color="orange" @click="getReq">submit</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
      <v-flex xs12 sm3>
        <v-card>
          ...
          <v-card-actions>
            <v-btn text color="orange" @click="postReq">submit</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
      <v-flex xs12 sm3>
        <v-card>
          ...
          <v-card-actions>
            <v-btn text color="orange" @click="putReq">submit</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
      <v-flex xs12 sm3>
        <v-card>
          ...
          <v-card-actions>
            <v-btn text color="orange" @click="delReq">submit</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
    </v-layout>
